...
- [Ask thinking models to think, and never resend the thinking](thinking-must-be-explicit.md) — think:false does not stop a qwen3-class model reasoning; it only moves the reasoning into content, where it pollutes the answer.
